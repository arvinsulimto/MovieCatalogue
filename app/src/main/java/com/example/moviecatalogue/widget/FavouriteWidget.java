...
public class FavouriteWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.example.moviecatalogue.widget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.moviecatalogue.widget.EXTRA_ITEM";
